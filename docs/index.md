...
hero:
  name: "Demo Idraulico Elettricista"
  text: "Template Angular 21 SSR"
  tagline: "Sito vetrina pre-configurato con dati mock realistici per PMI italiane"
  actions:
    - theme: brand
      text: Demo live
      link: https://idraulico-elettricista.demo.federicocalo.dev
    - theme: alt
      text: Source code
      link: https://github.com/fedcal/federico-demo-idraulico-elettricista
...
features:
  ...
  - icon: 📊
    ...
    details: Dati Italia 2026 (menu, listini, orari, prezzi medi) curati per il verticale Idraulico Elettricista.
  - icon: 🚀
...
Questo repository contiene il template **Angular 21 SSR** per un sito web professionale per **Idraulico Elettricista** in Italia.
...
Il mercato italiano delle PMI per **Idraulico Elettricista** ha caratteristiche specifiche:
...
```bash
npm run build
npm run serve:ssr:idraulico-elettricista
# → http://localhost:4000
```
...
- [GitHub repo](https://github.com/fedcal/federico-demo-idraulico-elettricista)
