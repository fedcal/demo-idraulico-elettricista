...
URL: `https://idraulico-elettricista.demo.federicocalo.dev`
...
2. Aggiungi custom domain in Vercel Dashboard:
   - Settings > Domains > Add `idraulico-elettricista.demo.federicocalo.dev`
...
- Output directory: `dist/idraulico-elettricista/browser`
...
Per usare `idraulico-elettricista-docs.federicocalo.dev` invece del subdirectory:

1. Cloudflare DNS aggiungi CNAME:
   ```
   idraulico-elettricista-docs    CNAME    fedcal.github.io    (proxy OFF)
   ```
2. Repo Settings > Pages > Custom domain: `idraulico-elettricista-docs.federicocalo.dev`
