...
const SLUG = 'idraulico-elettricista';
const TITLE = 'Demo Idraulico Elettricista — Federico Calò';

export default defineConfig({
  title: TITLE,
  description: 'Documentazione tecnica del template Angular 21 SSR per Idraulico Elettricista.',
  base: `/federico-demo-${SLUG}/`,
  cleanUrls: true,
  lang: 'it-IT',

  themeConfig: {
    siteTitle: 'Demo Idraulico Elettricista',
